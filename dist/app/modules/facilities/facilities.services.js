...
const createFacilityIntoDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const facility = yield facilities_model_1.Facility.create(payload);
    return facility;
});
const getAllFacilityFromDB = () => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield facilities_model_1.Facility.find();
    return result;
});
const updateFacilityIntoDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const updatedFields = __rest(payload, []);
    const result = yield facilities_model_1.Facility.findByIdAndUpdate(id, updatedFields, {
        new: true,
    });
    return result;
});
const deleteFacilityFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const deleteFacilities = yield facilities_model_1.Facility.findByIdAndUpdate(id, { isDeleted: true }, { new: true });
    if (!deleteFacilities) {
